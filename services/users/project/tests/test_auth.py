...
class TestAuthBlueprint(BaseTestCase):
    ...
    def test_user_registration_duplicate_email(self):
        add_user('danijel', 'danijel@danijel.com', 'test')
        with self.client:
            response = self.client.post(
                '/auth/register',
                data=json.dumps({
    ...
    def test_user_status(self):
        ...
        with self.client:
            ...
            self.assertTrue(data['data']['username'] == 'danijel')
            self.assertTrue(data['data']['email'] == 'danijel@danijel.com')
